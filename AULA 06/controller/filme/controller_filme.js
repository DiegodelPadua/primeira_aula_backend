...
const inserirNovoFilme = async function(filme) {
    ...
    }else if(filme.data_lacamento == '' || filme.data_lancamento == null || filme.data_lacamento == undefined || filme.data_lancamento.length != 10 ){

                message.ERROR_BAD_REQUEST.field = '[DATA_LACAMENTO] INVÁLIDO'
                //return message.ERROR_BAD_REQUEST //400

    }else if(filme.duracao == '' || filme.duracao == null || filme.duracao == undefined || filme.diracao.length < 5){
